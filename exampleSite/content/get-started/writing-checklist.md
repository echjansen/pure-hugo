...
Use this checklist to communicate in a way that is clear, helpful, and consistent with the rest of your website.
...
|Correct| Incorrect|
|:--|:--|
|Increase productivity with pure-hugo.| Productivity can be increased Linux.|
...
For example, 'Install pure-hugo.

##### Checked that the left-hand table of contents title in your website, matches the title displayed on the page
